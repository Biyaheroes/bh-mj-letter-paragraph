...
module.exports = function build( parameter ){
	...
	return {
		"entry": parameter.test? "./test.js" : "./letter-paragraph.support.js",
		...
		"output": {
			"library": parameter.test? "test" : "letter-paragraph",
			"libraryTarget": "umd",
			"filename": parameter.test? "test.deploy.js" : "letter-paragraph.deploy.js"
		},
